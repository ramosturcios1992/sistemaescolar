...
<body>
    ...
    <div class="header">
        ...
        <hr>
        <div>
            <a href="horarios-docente-lista-grados" class="btn btn-primary"><i class="fas fa-arrow-left"></i>&nbsp;&nbsp;&nbsp;REGRESAR</a>
        </div>
            ...
            $('#calendar').fullCalendar({
                ...
                events: [
                    ...
                    ?> {
                            ...
                            title: '<?php echo $event->nombre."-".$event->nom_grado."-".$event->nom_seccion; ?>',
