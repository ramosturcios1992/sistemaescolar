@extends('layouts/app')
@section('titulo', 'Lista Administrador')
@section('content')
    @if (Auth::user()->tipo == 1)
        <script>
        ...
        <div class="col-lg-12">
            ...
            <div class="text-right" style="margin-bottom: 5px;">
                <a href="{{ route('directors.create') }}" class="btn btn-primary"><i
                ...
                <tbody>
                    @foreach ($sql as $i)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('directors.edit', $i->id) }}" class="btn btn-warning btn-sm">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a href="{{ route('directors.destroy', $i->id) }}" onclick="return confirmarEliminar();"
