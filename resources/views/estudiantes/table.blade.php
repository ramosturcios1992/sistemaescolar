    ...
    @if (Auth::user()->tipo == 1)
        ...
        <div class="col-lg-12">
            ...
            <div class="text-right" style="margin-bottom: 5px;">
                <a href="{{ route('estudiantes.create') }}" class="btn btn-primary"><i
                ...
                <tbody>
                    @foreach ($sql as $i)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('estudiantes.edit', $i->id) }}" class="btn btn-warning btn-sm">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a href="{{ route('estudiantes.destroy', $i->id) }}" onclick="return confirmarEliminar();"
